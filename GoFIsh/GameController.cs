...
namespace GoFish
{
    ...
    public class GameController
    {
        ...
        public void NextRound(Player playerToAsk, Values valueToAskFor)
        {
            ...
            Status += string.Join(Environment.NewLine, gameState.Players.Select(player => player.Status));  //Добавить в статус информацию об всех игроках
            ...
            Status += Environment.NewLine + gameState.CheckForWinner();                                     //Проверить наличие победителей, добавить в статус
        }
